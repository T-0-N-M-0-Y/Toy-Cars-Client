...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="navbar p-3 bg-sky-800 sticky top-0">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-sky-800 text-white rounded-box w-52">
                            <Link to={"/"}>Home</Link>
                    ...
                    <div className="flex items-center">
                        ...
                        <h1 className="ml-2 text-2xl lg:text-3xl font-bold text-red-600">Toy <span className="text-yellow-400">Cars</span></h1>
                    </div>
                </div>
