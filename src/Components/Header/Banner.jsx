    ...
    return (
        <div>
            <div className="carousel md:w-full">
                <div id="slide1" className="carousel-item relative w-96 h-96 md:w-full md:h-screen">
                    ...
                    <div className="absolute flex justify-between items-center transform -translate-y-1/2 left-1 right-1 top-1/2">
                        ...
                        <div className="bg-gradient-to-r from-black p-10">
                            <p className="text-white font-semibold text-2xl md:font-bold md:text-8xl" data-aos="flip-right"
                                data-aos-easing="ease-out-cubic"
                                data-aos-duration="2000">Pick The Best Toy for your kids</p> <br />
                            <p className="text-white md:font-bold text-md md:text-2xl">Your Happiness Our Priority!!!</p> <br />
                ...
                <div id="slide2" className="carousel-item relative w-96 h-96 md:w-full md:h-screen">
                    ...
                    <div className="absolute flex justify-between items-center transform -translate-y-1/2 left-1 right-1 top-1/2">
                        ...
                        <div className="bg-gradient-to-r from-black p-10">
                            <p className="text-white font-semibold text-2xl md:font-bold md:text-8xl">Get a Bonus on First Order</p> <br />
                            <p className="text-white md:font-bold text-md md:text-2xl">Best Offers For Regular Customers!!!</p> <br />
                            <Link className="bg-red-600 p-2 lg:p-3 font-bold text-white rounded-lg hover:bg-yellow-500" to={"/alltoys"}> <button>Discover</button></Link>
                        </div>
                        <a href="#slide3" className="btn btn-circle bg-sky-800 hover:bg-sky-500 text-white border-none">❯</a>
                    </div>
                </div>
                <div id="slide3" className="carousel-item relative w-96 h-96 md:w-full md:h-screen">
                    ...
                    <div className="absolute flex justify-between items-center transform -translate-y-1/2 left-1 right-1 top-1/2">
                        <a href="#slide2" className="btn btn-circle bg-sky-800 hover:bg-sky-500 text-white border-none">❮</a>
                        <div className="bg-gradient-to-r from-black p-10">
                            <p className="text-white font-semibold text-2xl md:font-bold md:text-8xl">Pick The Best Toy</p> <br />
                            <p className="text-white md:font-bold text-md md:text-2xl">We offer Premium Services!!!</p> <br />
                            <Link className="bg-red-600 p-2 lg:p-3 font-bold text-white rounded-lg hover:bg-yellow-500" to={"/alltoys"}> <button>Discover</button></Link>
                        </div>
                        <a href="#slide4" className="btn btn-circle bg-sky-800 hover:bg-sky-500 text-white border-none">❯</a>
                    </div>
                </div>
                <div id="slide4" className="carousel-item relative w-96 h-96 md:w-full md:h-screen">
