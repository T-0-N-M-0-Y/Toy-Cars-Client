const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-sky-800 text-base-content text-white">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-sky-800 text-white text-base-content border-base-300">
